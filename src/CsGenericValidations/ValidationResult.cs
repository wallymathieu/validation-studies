...
namespace CsGenericValidations
{
    ...
    {
        public class Success : ValidationResult<TSuccess,TFailure> { public new TSuccess Value { get; protected internal set; } }  
        public class Failure  : ValidationResult<TSuccess,TFailure> { public new TFailure Value { get; protected internal set; } }
